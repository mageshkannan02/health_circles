...
router.get('/specificrxgroups',Controller.getSpecific_rxGroups);
...
router.get('/days',Controller.get_days)

router.post('/addDoctors', Controller.post_doctors);
router.post('/addrxgroups', Controller. post_rx_groups);
router.post('/addrxgroupsdrugs', Controller. post_rxGroups_with_drugs);
